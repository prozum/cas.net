...
namespace CAS.NET.Desktop
{
    class MainWindow : Window
    {
            ...
            : base("CAS.NET")
        {
            ...
            newFile.Activated += (o, a) => UpdateHandling.ClearWindow();

            MenuItem openFile = new MenuItem("Open File");
            openFile.Activated += (o, a) => DialogOpenFile.OpenFile();

            MenuItem saveFile = new MenuItem("Save File");
            saveFile.Activated += (o, a) => DialogSaveFile.SaveFile();
            ...
            addEntry.Activated += (object sender, EventArgs e) => Widgets.AddEntryWidget();

            MenuItem addTextView = new MenuItem("TextView");
            addTextView.Activated += (object sender, EventArgs e) => Widgets.AddTextViewWidget();
            ...
            loginItem.Activated += (object sender, EventArgs e) => LoginWindow.StartLoginWindow();
            ...
            GlobalVar.vboxWindow.PackStart(menuBar, false, false, 2);
            GlobalVar.vboxWindow.Add(GlobalVar.globalGrid);

            Add(GlobalVar.vboxWindow);
